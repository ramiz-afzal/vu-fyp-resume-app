...
export default function Layout() {
	return (
		<Stack>
			...
			<Stack.Screen name="[id]/departments/[itemId]/employees/create" options={{ title: 'Add Employee' }} />
			<Stack.Screen name="[id]/departments/[itemId]/employees/[employeeId]/update" options={{ title: 'Update Employee' }} />
		</Stack>
	);
}
